...
export const CATEGORY_CONFIG: Record<CalendarEventCategory, { label: string; dotClass: string; badgeVariant: "default" | "success" | "warning" | "danger" | "info" | "neutral" }> = {
  holiday: { label: "Holiday", dotClass: "bg-warning", badgeVariant: "warning" },
  exam: { label: "Exam", dotClass: "bg-destructive", badgeVariant: "danger" },
  academic: { label: "Academic calendar", dotClass: "bg-violet-500", badgeVariant: "info" },
  event: { label: "Event", dotClass: "bg-info", badgeVariant: "info" },
  homework: { label: "Homework due", dotClass: "bg-success", badgeVariant: "success" },
